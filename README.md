...
```mermaid
graph TD
    SN[ServiceNow Instance] -->|REST| service-catalog-ai-migrator
    service-catalog-ai-migrator -->|Store| DB[x_service-catalog-ai-migrator_tables]
    service-catalog-ai-migrator -->|Output| Report[Reports MD/JSON/CSV]
