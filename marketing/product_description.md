...
Автоматический анализ инстанса ServiceNow и генерация полного плана миграции на AI-агентов за 5 минут вместо 2 недель.

## Short Description (для GitHub)

ServiceNow AI Migration Architect — open-source CLI tool that connects to your ServiceNow instance, auto-discovers all catalog items, workflows, scripts, and history, then generates a complete AI agent migration blueprint: executive summary, TOR, technical specs with architecture diagrams, per-workflow AI agent topology, phased roadmap, risk register, and training plan.
...
- Executive Summary (CTO-ready, in Russian)
...
| Ресурс | Значение |
|---|---|
| Catalog Items (всего) | **197** |
| Catalog Items (активные) | **147** |
| Workflows | **6** |
| Интеграции (sys_rest_message) | **11** |
| Script Includes | **4,765** |
| Business Rules | **5,654** |
| Запросы (sc_request) | **13** |
| Request Items (sc_req_item) | **5** |
| Категории | **45** |

### ServiceNow AI Platform Landscape (verified from official docs — Australia release)

Based on the **Australia release** (latest as of May 2026) — ServiceNow's AI platform for business transformation.

#### Core AI Components (Australia)

| Component | Official Name | Description |
|---|---|---|
| AI Agent Builder | **AI Agent Studio** | Create, manage, test AI agents and agentic workflows. Low-code guided setup with tool binding, human-in-the-loop rules. |
...
| LLM Integration | **Generative AI Controller** | Integrates third-party LLMs (BYOK): Azure OpenAI, Amazon Bedrock, Google Vertex AI, IBM watsonx. Generic LLM connector. |
| AI Governance | **Generative AI Controller** | Centralized prompt management, model routing, guardrails, audit trail. Now Assist Guardian (offensiveness + prompt injection detection). |
...
#### Platform Agentic Workflows (Australia release — from official docs)
...
- **197 catalog items** (147 active), **6 workflows**, **11 integrations**, **4,765** script includes
